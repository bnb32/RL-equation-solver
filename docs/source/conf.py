...
latex_documents = [
    (
        master_doc,
        "rl_equation_solver.tex",
        "Rl-Equation-Solver Documentation",
        "Brandon Benton, Kevin O'Keefe",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "rl_equation_solver", "RL-Equation-Solver Documentation", [author], 1)
]
